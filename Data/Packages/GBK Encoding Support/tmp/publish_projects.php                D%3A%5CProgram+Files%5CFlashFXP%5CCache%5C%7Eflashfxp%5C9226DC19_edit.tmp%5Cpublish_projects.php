...
<div class="press" id="place_1">
    ...
    <textarea name="describe_content" id="describe_content" style="width:635px;height:120px;visibility:hidden;"><?php echo htmlspecialchars($describe_content); ?></textarea>
    ...
    <table width="100%" border="0" cellspacing="0" cellpadding="0">
        ...
        <tr>
            ...
            <td>
                ...
                <div id='div_place_map_img' style="width:550px;height:410px;overflow:auto;margin-top:6px;display:none"><img id="place_map_img" src="<?php echo $place_map;?>"/></div>
            </td>
...
<div class="tructure" id="place_3" style="display:none">
    ...
    <table width="100%" border="0" cellspacing="0" cellpadding="0">
        ...
        <tr>
            <td align="left" valign="middle">
                <textarea name="build_zjxx" id="build_zjxx" style="width:635px;height:120px;visibility:hidden;"><?php echo htmlspecialchars($build_zjxx); ?></textarea>
            </td>
        </tr>
    </table>
    <table width="100%" border="0" cellspacing="0" cellpadding="0">
    ...
    <table width="100%" border="0" cellspacing="0" cellpadding="0">
        ...
        <tr>
            <td colspan="2" align="left" valign="top">
                <textarea name="facility_zbpt" id="facility_zbpt" style="width:550px;height:70px;visibility:hidden;"><?php echo htmlspecialchars($facility_zbpt); ?></textarea>
    ...
    <table width="580" border="0" cellspacing="0" cellpadding="0" style="margin-left:0;">
        ...
        <tr>
            ...
            <td align="left" valign="top">
                ...
                <textarea name="trade_qttj" id="trade_qttj" style="width:435px;height:120px;visibility:hidden;"><?php echo htmlspecialchars($trade_qttj); ?></textarea>
            </td>
        </tr>
        <tr><td height="7" align="left" valign="middle"></td></tr>
    </table>
    ...
    <table width="624" border="0" cellspacing="0" cellpadding="0">
        ...
        <tr>
            ...
            <td align="left" valign="top">
                ...
                <textarea name="owner_gsjs" id="owner_gsjs" style="width:535px;height:120px;visibility:hidden;"><?php echo htmlspecialchars($owner_gsjs); ?></textarea>
            </td>
        </tr>
        <tr><td height="7" align="left" valign="middle"></td></tr>
    </table>
