...
<?php getleft(); ?>
       ...
       <div class="Gray">
         <div class="manage ">个人信息 <label class="script"> Personal Information</label></div>
          ...
          <ul>
           ...
           <li><label></label><a href="company_profile_S.php?m=<?php echo $_REQUEST["m"];?>">公司档案 <span> Company Profile</span></a></li>
          </ul>
         </div>
         ...
         <input type="hidden" name="city" id="city" value="<?php echo $city;?>"/>
            ...
            <div class="colleague">
             <div class="heading"><span>会员姓名： <?php echo $truename;?>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;会员编号： <?php echo $_SESSION['verydeals_users_sn'];?></span></div>
              <div class="quired">
  ...
  <tr>
   ...
   <tr>
   <td width="35%"><div style="float: left;width:189px; height:205px;overflow: hidden;"><img id="txtimg" style="width: 100%;float:left;" src="<?php echo $img;?>"/></div><input type="hidden" name="img" id="img" value="<?php echo $img;?>"/></td>
   <td align="left" valign="bottom" width="65%"><iframe src="ajaxfileupload_user_info.php?txtid=img&imgid=txtimg" onload="turnHeight('iframe1');" frameBorder=0 scrolling="no" style="height:25px;"></iframe></td>
   </tr>
   </table>
  ...
  <td align="center" valign="top"><font color="#d7433f">*</font></td>
    ...
    <div class="pick2 moon">
     ...
     <div class="nextse2 Copy" id="div_provincial"></div>
        ...
        <label>市</label>
    <div class="pick moon">
     <div class="choose" id="first_city_name"></div>
