<?php
  ...
  while($rs=mysql_fetch_array($sql)) 
  {
		 ...
		 else
		 {
		    ...
		    $pro_cityslist.="<dd name='dd_citys' id='dd_citys'><a href='javascript:void(0)' name='link_pro_citys_more'  id='css_citys_".$rs["id"]."' onclick=\"set_xlink('link_pro_citys_more','css_citys_','pro_citys',".$rs["id"]."),getcbd(".$rs["id"].");showmore('link_pro_cbd','pro_cbd_more','is_show_pro_citys_more');\">".$rs["name"]."</a></dd>";
		 }
		 if($pro_citys==$rs["id"])
		 {
            if($i>5)
