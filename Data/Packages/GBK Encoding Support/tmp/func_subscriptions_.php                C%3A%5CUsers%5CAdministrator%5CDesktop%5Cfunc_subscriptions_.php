...
if($_SESSION['verydeals_user_type']==4)
{
	...
	$menuGlide = $pk==2?"<li><span></span><a href='my_subcriptions_a1.php?mp=5'><h2>·?μ?2úí?×ê</h2>Real Estate Investment</a><label></label></li>
<li class='Glide'><span></span><a href='subscriptions_.php?pk=2&mp=5'><h2>1éè¨í?×ê</h2>Equity Investment</a><label></label></li><li><span></span><a href='subscriptions_.php?pk=3&mp=5'><h2>??è¨èú×ê</h2> Debt Financing</a><label></label></li>":"<li><span></span><a href='my_subcriptions_a1.php?mp=5'><h2>·?μ?2úí?×ê</h2>Real Estate Investment</a><label></label></li>
<li><span></span><a href='subscriptions_.php?pk=2&mp=5'><h2>1éè¨í?×ê</h2>Equity Investment</a><label></label></li><li class='Glide'><span></span><a href='subscriptions_.php?pk=3&mp=5'><h2>??è¨èú×ê</h2> Debt Financing</a><label></label></li>";

}
else
{
	$menuGlide = $pk==2?"<li><span></span><a href='Subscriptions.php?m=scpt'><h2>·?μ?2úí?×ê</h2>Real Estate Investment</a><label></label></li>
<li class='Glide'><span></span><a href='subscriptions_.php?pk=2&m=scpt'><h2>1éè¨í?×ê</h2>Equity Investment</a><label></label></li><li><span></span><a href='subscriptions_.php?pk=3&m=scpt'><h2>??è¨èú×ê</h2> Debt Financing</a><label></label></li>":"<li><span></span><a href='Subscriptions.php?m=scpt'><h2>·?μ?2úí?×ê</h2>Real Estate Investment</a><label></label></li>
<li><span></span><a href='subscriptions_.php?pk=2&m=scpt'><h2>1éè¨í?×ê</h2>Equity Investment</a><label></label></li><li class='Glide'><span></span><a href='subscriptions_.php?pk=3&m=scpt'><h2>??è¨èú×ê</h2> Debt Financing</a><label></label></li>";
...
$table=($pk==2) ? "" : "2";
  ...
  {
	   if(!empty($_REQUEST["hinvestment_type"]))//′??úDDòμààDí
		{  
			for($y=0; $y< $size; $y++)
			{ 
			  if($array[$y]==$rs["id"])
    ...
    if($i>5)
  {
	  $investment_typemore = "<div id='investment_type_more' onclick=\"showmore('link_investment_type_more','investment_type_more','is_show_investment_type_more')\" style='cursor:pointer;color:#666'>?ü?à>></div>";
  }
     if(!empty($_REQUEST["hinvestment_type"]))
  {
	$sqlwhere.=" ) ";
  ...
  while($rs=mysql_fetch_array($sql)) 
  {
    ...
    if($i>7)
  {
	  $industry_typemore = "<div id='industry_type_more' onclick=\"showmore('link_industry_type_more','industry_type_more','is_show_industry_type_more')\" style='cursor:pointer;color:#666'>?ü?à>></div>";
  }
     if(!empty($_REQUEST["hindustry_type"]))
  {
	$sqlwhere.=" ) ";
 ...
 /*?ù?ú3?êD*/
  ...
  if($i>9)
  {
	  $pro_citysmore = "<div id='pro_citys_more' onclick=\"showmore('link_pro_citys_more','pro_citys_more','is_show_pro_citys_more')\" style='cursor:pointer;color:#666'>?ü?à>></div>";
  }
 ...
 /*??ò×±¨??*/
  ...
  while($rs=mysql_fetch_array($sql)) 
  {
		...
		{  
		 ...
		 if($i>5)
		 {
		    ...
		    $pro_offerlist.="<dd><a href='javascript:void(0)' style='display:none' name='link_pro_offer_more' id='link_pro_offer_".$rs["id"]."' onclick=\"setPro_flag('hpro_offer','link_pro_offer','dd_pro_offer',".$rs["id"].",'".$rs["name"]."');\">".$rs["name"]."</a></dd>";
		 }
		 else
		 {
  ...
  if($i>5)
  {
	  $pro_offermore = "<div id='pro_type_more' onclick=\"showmore('link_pro_type_more','pro_type_more','is_show_pro_type_more')\" style='cursor:pointer;color:#666'>?ü?à>></div>";
  }
...
if($ordertype=="createtime")
{
	if($isdesc=="desc")
	{
		$orderbylist = "<div class='Time_'><a href='#' onclick=\"setorder('price')\">??ò×±¨??</a></div><div class='Time_'><a href='#' class='action' onclick=\"setorder('createtime')\">·￠2?ê±??</a></div>";

	}
	else
	{
		$orderbylist = "<div class='Time_'><a href='#' onclick=\"setorder('price')\">??ò×±¨??</a></div><div class='Time_'><a href='#' onclick=\"setorder('createtime')\">·￠2?ê±??</a></div>";
...
else if($ordertype=="price")
{
	if($isdesc=="desc")
	{
		$orderbylist = "<div class='Time_'><a href='#' class='action' onclick=\"setorder('price')\">??ò×±¨??</a></div><div class='Time_'><a href='#'  onclick=\"setorder('createtime')\">·￠2?ê±??</a></div>";
        ...
        if($subscription_pro_citys!="")
		{
				...
				while($row = mysql_fetch_array($dt))
				{
				   ...
				   $xpro_areaname = $rs["name"];
					...
					if($sct_investment_type==''){$sct_investment_type='è?2?';}
					if($sct_industry_type==''){$sct_industry_type='è?2?';}
					if($sct_pro_offer==''){$sct_pro_offer='è?2?';}
				  ...
				  $rs_x=mysql_fetch_array(mysql_query("select * from subscription where userid = ".$_SESSION['verydeals_id']." and pro_kind='".$_REQUEST["pk"]."' and investment_type = '".$sct_investment_type."' and industry_type = '".$sct_investment_type."' and pro_offer ='".$sct_pro_offer."' and pro_citys = '".$sct_pro_citys."' ;"));//2é?ˉò?′?ê?·?′??ú1y???ü?μ
                  if($rs_x!=true)
				  {
					...
					if($rs==true)
					 {
						 if($rs["companymail"]!="")
						 {
                             ...
                             //todo ·￠?í????óê?t
									...
									//sendmail($rs["companymail"],"ítμ?í?×êD??￠?ì±¨ VD Newsletter",$mail_content);
						 }
					 }
				  }
...
<?php echo $menuGlide; ?>
  ...
  <tr>
    <td width="75" align="left" valign="top"><h2><?php if($_REQUEST['pk']==2) echo "í?×êààDí";else echo "èú×êààDí"; ?>￡o</h2></td>
    <td width="40" align="left" valign="top"><a href="#" id='link_investment_type_all' class="Unique" onclick="del_all_flag('hinvestment_type','link_investment_type','dd_investment_type','link_investment_type_all')">è?2?</a></td>
...
<dd id='dd_investment_type' style='display:none'></dd>
        ...
        <div class="Sail">
          <table width="623" border="0" cellspacing="0" cellpadding="0">
  <tr>
    <td width="75" align="left" valign="top"><h2>?ùê?DDòμ￡o</h2></td>
    <td width="40" align="left" valign="top"><a href="#" class="Unique" id='link_industry_type_all' onclick="del_all_flag('hindustry_type','link_industry_type','dd_industry_type','link_industry_type_all')">è?2?</a></td>
    <td align="left" valign="top">
    <dl class="genre">
...
<dd id='dd_industry_type' style='display:none'></dd>
        ...
        <div class="Sail">
          <table width="623" border="0" cellspacing="0" cellpadding="0">
  <tr>
    <td width="75" align="left" valign="top"><h2>?ù?ú3?êD￡o</h2></td>
    <td width="40" align="left" valign="top"><a href="#" id='link_pro_citys_all' class="Unique" onclick="del_all_flag('hpro_citys','link_pro_citys','dd_pro_citys','link_pro_citys_all')">è?2?</a></td>
    <td align="left" valign="top">
    <dl class="genre">
...
<dd id='dd_pro_citys' style='display:none'><input type="hidden" name="pro_citys[]" id="pro_citys" value="<?php echo $pro_cityfirst;?>"/></dd>
        ...
        <div class="Sail">
          <table width="623" border="0" cellspacing="0" cellpadding="0">
  <tr>
    <td width="75" align="left" valign="top"><h2>??ò×±¨??￡o</h2></td>
    <td width="40" align="left" valign="top"><a href="#" class="Unique" id='link_pro_offer_all' onclick="del_all_flag('hpro_offer','link_pro_offer','dd_pro_offer','link_pro_offer_all')">è?2?</a></td>
    <td align="left" valign="top">
    <dl class="acreage">
...
<dd id='dd_pro_offer' style='display:none'></dd>
        ...
        <div class="Select">
         <table width="623" border="0" cellspacing="0" cellpadding="0">
  <tr>
    <td width="75" align="left" valign="top"><h2>?úò?????￡o</h2></td>
    <td align="left" valign="top" class="infer">
     <a href="#" title="è???" class="par"><label>í?×êààDí￡o</label>·???í?×ê</a>
     <a href="#" title="è???" class="par"><label>?ùê?DDòμ￡o</label>·?μ?2ú</a>
     <a href="#" title="è???" class="par"><label>?ù?ú??óò￡o</label>±±??</a>
     <a href="#" title="è???" class="par"><label>??ò×±¨??￡o</label>5?§íò??1òú</a>
    </td>
  </tr>
</table>
  ...
  <tr>
    <td colspan="2" align="left" valign="top">?úμ?????óê??￡o<?php echo $email;?></td>
    </tr>
 <!-- <tr>
    <td colspan="2" align="left" valign="top">???????ò±¨·￠?í?μ?ê￡¨?é?à??￡?￡o</td>
    </tr>-->
  <tr>
    <td colspan="2">
     <table width="662" border="0" cellspacing="0" cellpadding="0">
  <tr>
    <td width="73" align="left" valign="top">?????é?¤??￡o</td>
    <td width="96" align="left" valign="top"><input type="text" class="code" name="chkcode" id="chkcode" /></td>
    <td width="498" align="left" valign="top"><!--<img src="checkNum_session.php" id="checkimg" style="cursor:pointer;width:60px; height:24px;" class="codeImg"  onClick="this.src = 'checkNum_session.php?' + Math.random();"/>--><img id="code" src="verfy.php" style="margin-top:5px;" class="img" width="60" height="24" alt="?′2???3t￡???ò???" title="?′2???3t￡???ò???" style="cursor: pointer; vertical-align:middle;" onClick="this.src=this.src+'?'+Math.random();" /></td>
  </tr>
      <tr style="display:none" id="tr_err">
    <td colspan="3" align="left" valign="top"  style="color: #f00;">?é?¤??2??yè·</td>
    </tr>
</table>
