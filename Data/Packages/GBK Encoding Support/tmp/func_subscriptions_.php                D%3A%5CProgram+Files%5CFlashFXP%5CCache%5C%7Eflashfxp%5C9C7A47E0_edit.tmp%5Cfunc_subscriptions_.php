...
<dd id='dd_industry_type' style='display:none'></dd>
  ...
  <tr>
    ...
    <td width="40" align="left" valign="top" style="display:none"><a href="#" id='link_pro_citys_all' class="Unique" onclick="del_all_flag('hpro_citys','link_pro_citys','dd_pro_citys','link_pro_citys_all')">全部</a></td>
    <td align="left" valign="top">
    <dl class="genre">
...
<dd id='dd_pro_offer' style='display:none'></dd>
  ...
  <tr>
    ...
    <td width="498" align="left" valign="top"><img src="checkNum_session.php" id="checkimg" style="cursor:pointer;width:60px; height:24px;" class="codeImg"  onClick="this.src = 'checkNum_session.php?' + Math.random();"/></td>
  </tr>
