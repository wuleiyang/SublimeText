...
<script type="text/javascript">    uaredirect("/web_mobile/Index.aspx?num=1");</script>
</head>
<body>
	<!-- 头部 -->
		...
		<div class="content">
					...
					<div class="new_con con_pd">
						<div class="new_con_l">
							...
							<div class="new_con_txt">
								<p><%=content%></p>
								<a href="<%=linkurl %>"><img src="<%=imgurl1 %>" alt=""></a>
							</div>
						</div>
						<div class="new_con_r">
							<ul>
			...
			<div class="con_r">
				<div class="video_box">
					<div class="con_r_video bd_radius2 video_layer">
						...
						<object style="display:none;" class id="clsid:D27CDB6E-AE6D-11cf-96B8-444553540000" codebase="http://download.macromedia.com/pub/shockwave/cabs/flash/swflash.cab#version=7,0,19,0" width="330" height="231">
                                  ...
                                  <param name="FlashVars" value="vcastr_file=<%=video %>&&BufferTime=3&IsAutoPlay=0">
                                  <embed src="flvplayer.swf" allowfullscreen="true" flashvars="vcastr_file=<%=video %>&&IsAutoPlay=0" quality="high" pluginspage="http://www.macromedia.com/go/getflashplayer" type="application/x-shockwave-flash" width="330" height="231"></embed>
                                </object>
						</div>
						<i>
				...
				<div class="share_btn bd_radius2">
					<a href="../web_form/FllowUs.aspx?num=7"><div class="sina"><i><img src="../images/sina.jpg" alt=""></i>官方微博&nbsp;Weibo</div></a>
					<a href="../web_form/FllowUs.aspx?num=7"><div class="wx"><i><img src="../images/wx.jpg" alt=""></i>官方微信&nbsp;WeChat</div></a>
				</div>
				<!-- 地图 -->
...
<script type="text/javascript">
    jQuery(".slideBox1").slide({ mainCell: ".bd ul", autoPlay: true }); //主页大bannner滚动
</script>
