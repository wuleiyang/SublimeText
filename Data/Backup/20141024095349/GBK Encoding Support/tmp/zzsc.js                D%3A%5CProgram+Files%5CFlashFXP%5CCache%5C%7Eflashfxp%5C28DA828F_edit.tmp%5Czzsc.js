...
*/
$(function (argument) {
			$("#slide_list li.cur").find('a').hover(function() {
				$(this).find('p').stop().animate({bottom:0},200);
			}, function() {
				$(this).find('p').stop().animate({bottom:-106},200);
				
			});
			$("#slide_list li.cur").click(function(event) {
			$(".slider-container").animate({
				top: -588},500).siblings('.pro_fl').animate({top:0},500);
			});
	// body...
});
var slide = (function() {
